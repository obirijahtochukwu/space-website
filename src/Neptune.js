...
import { neptune } from './data';

export default function Neptune() {
 // eslint-disable-next-line
 const [neptunes, setneptunes] = useState(neptune);
 ...
 return (
  <div>
   {
    neptunes.map((neptune)=>{
     // eslint-disable-next-line
     const {id, planet, overview, internal, rotation, revolution, temp, radius, text,img} = neptune;
     return (
