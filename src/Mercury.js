...
import { mercury } from './data';

export default function Mercury() {
 // eslint-disable-next-line
 const [mercurys, setMercurys] = useState(mercury);
 ...
 return (
  <div>
   {
    mercurys.map((mercury)=>{
     // eslint-disable-next-line
     const {id, planet, overview, internal, rotation, revolution, temp, radius, text,img} = mercury;
     return (
