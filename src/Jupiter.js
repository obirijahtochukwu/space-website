...
import { jupiter } from './data';

export default function Jupiter() {
 // eslint-disable-next-line
 const [jupiters, setjupiters] = useState(jupiter);
 ...
 return (
  <div>
   {
    jupiters.map((jupiter)=>{
     // eslint-disable-next-line
     const {id, planet, overview, internal, rotation, revolution, temp, radius, text,img} = jupiter;
     return (
